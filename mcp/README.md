...
[EnvSync-LE](https://marketplace.visualstudio.com/items?itemName=nolindnaidoo.envsync-le)
...
· [Open VSX](https://open-vsx.org/extension/OffensiveEdge/envsync-le)
· [Zed](https://github.com/zed-industries/extensions/pull/7084) *(pending review)*
