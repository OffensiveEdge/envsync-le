...
spot missing keys across .env files. It runs inside someone's editor, on
their files, while they work — so it is judged on staying out of the way as
much as on being right.
